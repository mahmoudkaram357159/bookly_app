...
class HomeRepoImp implements HomeRepo {
  ...
  @override
  Future<Either<Failure, List<BookModel>>> similarFeaturedBooks({required String category})async {
     try {
      var data = await appService.get(endPoint: Constants.endPointSimilarBooks);
      List<BookModel> books = [];
      for (var item in data['items']) {
        books.add(BookModel.fromJson(item));
      }
